# nohup python Match_journal_classification_MAG2JCR.py -u > Match_journal_classification_MAG2JCR.log 2>&1 &
...
if __name__ == '__main__':
    ...
    pk.dump(journal_cate,open('journal_cate.pkl','wb'))
    pk.dump(not_matched_by_issn,open('not_matched_by_issn.pkl','wb'))